...
# ---- System Prompt (to be replaced with your actual prompt) ----
...
if generate_btn and prompt:
    ...
    # Add the new user message -- use json.dumps, NOT str()
    ...
    try:
        ...
        # Collect variants, defensively extract only the first JSON object from each output
...
if st.session_state.last_output:
    ...
    if edit_btn and follow_up:
        ...
        # These are JSON strings, so load them as dicts for correct embedding
        ...
        try:
            ...
            # ---- Store RAW INPUT and RAW OUTPUT for always-visible debug ----
            st.session_state.raw_input_text = json.dumps(st.session_state.chat_history, indent=2)
            st.session_state.raw_output_text = json.dumps(result, indent=2)
